...
import { IconPropsType } from '../types/modules/icons';

export const InstagramIcon = (props: IconPropsType): ReactElement => {
  return (
    <svg
...
export const FacebookIcon = (props: IconPropsType): ReactElement => {
  return (
    <svg
      className={props.className}
      stroke="currentColor"
...
export const PinterestIcon = (props: IconPropsType): ReactElement => {
  return (
    <svg
      className={props.className}
      stroke="currentColor"
...
export const YoutubeIcon = (props: IconPropsType): ReactElement => {
  return (
    <svg
      className={props.className}
      stroke="currentColor"
...
export const EtsyIcon = (props: IconPropsType): ReactElement => {
  return (
    <svg
      className={props.className}
      stroke="currentColor"
